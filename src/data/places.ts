...
export const places: Place[] = [
  ...
  // Museos
  {
    ...
    category: "museo",
    description: "Museo interactivo sobre el ser humano diseñado por Arata Isozaki. Edificio icónico con fachada de pizarra curvada que mira al mar.",
    tip: "Muy estimulante y diferente. Entrada ~3€. Está junto a la playa de Riazor, en Ronda de Monte Alto.",
    lat: 43.3782,
    lng: -8.4067,
